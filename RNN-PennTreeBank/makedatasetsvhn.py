...
parser.add_argument("--dataset", "-d", default="svhn", type=str, help="dataset name : [svhn, cifar10, cifar10_zca]")
...
COUNTS = {
    ...
    "cifar10_plain": {"train": 50000, "test": 10000, "valid": 5000, "extra": 0},
    "imagenet_32": {
        "train": 1281167,
        "test": 50000,
        "valid": 50050,
...
elif args.dataset == "cifar10_plain":
    train_set, test_set = _load_cifar10()
    # train_set["images"] = gcn(train_set["images"])
    # test_set["images"] = gcn(test_set["images"])
    # mean, zca_decomp = get_zca_normalization_param(train_set["images"])
